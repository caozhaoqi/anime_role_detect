...
def download_blue_archive_characters(output_base_dir, image_limit=5):
    ...
    # 蔚蓝档案角色列表
    blue_archive_roles = [
        "blue_archive hoshino",          # 星野
        "blue_archive shiroko",          # 白子
        "blue_archive ichinose_asuna",   # 一之濑明日奈
        "blue_archive kuroko",           # 黑子
        "blue_archive arona",            # 阿罗娜
        "blue_archive miyako",           # 宫子
        "blue_archive hina",             # 日奈
        "blue_archive yuuka",            # 优花梨
    ]
