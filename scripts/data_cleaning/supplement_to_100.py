...
SOURCE_DIRS = [
    ...
    Path('/Users/caozhaoqi/PycharmProjects/anime_role_detect/data/detection/multi_face_detected_anime/multi_face'),
    Path('/Users/caozhaoqi/PycharmProjects/anime_role_detect/data/detection/multi_face_detected/multi_face'),
