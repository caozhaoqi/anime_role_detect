...
def main():
    ...
    # 剩余需要下载的角色
    roles = [
        ('月千夜', 'yue4qian1ye4'),   # 47张 → 需3张 (有51个URL)
        ('爱丽儿', 'ai4li4er3'),      # 41张 → 需9张 (有41个URL)
        ('小闪', 'xiao3shan3'),       # 29张 → 需21张 (有29个URL)
        ('釉壶', 'you4hu2'),          # 29张 → 需21张 (有6个URL)
        ('克萝萝', 'ke4luo2luo2'),    # 20张 → 需30张 (有20个URL)
        ('芙丽希娅', 'fu2li4xi1ya4'),  # 11张 → 需39张 (有11个URL)
    ]
