...
URL_DIR_CN = '/Users/caozhaoqi/PycharmProjects/anime_role_detect/archived/spider_image_system/data/img_url'
...
def main():
    ...
    for role in insufficient_roles:
        print(f"{role['name']:<15} {role['chinese_name']:<12} {role['current_images']:<10} {role['current_urls']:<10} {role['needed_urls']:<10}")
    print("-" * 70)
