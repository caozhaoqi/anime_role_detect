...
def create_tables():
    ...
    # 创建索引
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_image_records_user_id ON image_records (user_id)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_image_records_image_id ON image_records (image_id)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_image_records_role_id ON image_records (role_id)')
