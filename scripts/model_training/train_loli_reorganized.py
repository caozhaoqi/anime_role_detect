...
# -*- coding: utf-8 -*-
"""
训练角色分类模型 - 使用reorganized_dataset数据集
"""
...
try:
    ...
    logger = get_logger("train_loli_reorganized")
except ModuleNotFoundError:
    import logging
    logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
    logger = logging.getLogger("train_loli_reorganized")
