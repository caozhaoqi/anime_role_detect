...
def main():
    ...
    try:
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            history = model.fit(train_generator, epochs=1, validation_data=val_generator, verbose=1)
        ...
        final_model_path = os.path.join(
            MODEL_SAVE_PATH, f'final_model_{datetime.now().strftime("%Y%m%d_%H%M%S")}.h5'
        )
