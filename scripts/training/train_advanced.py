...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='efficientnet_b0', choices=MODEL_ZOO.keys())
    parser.add_argument('--epochs', type=int, default=50)
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--lr', type=float, default=0.001)
    parser.add_argument('--image_size', type=int, default=224)
    parser.add_argument('--augment_level', type=str, default='high', choices=['low', 'medium', 'high'])
    ...
    # 训练模型
    print("🚀 开始训练...")
    model, best_acc, train_history = train_model(model, dataloaders, criterion, optimizer, scheduler, device, args)
