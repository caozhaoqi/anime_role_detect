...
def evaluate_model_on_collected_data(model, dataloader, device, class_to_idx, idx_to_class):
    ...
    return {
        ...
        'class_accuracy': {k: 100. * class_correct[k] / class_total[k] if class_total[k] > 0 else 0
...
def main():
    ...
    for model_type in model_types:
        ...
        try:
            ...
            result = evaluate_model_on_collected_data(model, dataloader, device, class_to_idx, idx_to_class)
        ...
        json.dump({
            ...
            'results': {
                k: {
                    ...
                    if key not in ['all_preds', 'all_labels', 'all_probs', 'all_paths', 'misclassified']
                }
