...
class LeftPanel(QScrollArea):
    ...
    def init_ui(self):
        ...
        self.role_search.setStyleSheet(
            f"""
            QLineEdit {{
...
class RightPanel(QWidget):
    ...
    def _create_image_section(self):
        ...
        nav_bar.setStyleSheet(
            f"background-color: {STYLES['bg_input']}; border-radius: {STYLES['border_radius']}; padding: 6px;"
        )
        ...
        self.zoom_value_label.setStyleSheet(
            f"color: {STYLES['primary_color']}; font-weight: 600; font-size: 11px;"
        )
    ...
    def _create_annotation_section(self):
        ...
        self.annotation_group.setStyleSheet(
            f"""
            QWidget {{
                background-color: {STYLES['bg_card']};
                border: 1px solid {STYLES['border_color']};
        ...
        self.selected_roles_label.setStyleSheet(
            f"color: {STYLES['primary_color']}; font-weight: 500; font-size: 12px;"
        )
        ...
        self.nsfw_check.setStyleSheet(
            f"QCheckBox {{ color: {STYLES['danger_color']}; font-size: 12px; }}"
        )
        ...
        ai_infer_btn.setStyleSheet(
            get_gradient_button_style(STYLES["secondary_color"], "#a855f7", "#a78bfa", "#c084fc")
        )
        ...
        move_r18_btn.setStyleSheet(
            get_gradient_button_style("#ef4444", "#f97316", "#f87171", "#fb923c")
        )
        ...
        move_multi_btn.setStyleSheet(
            get_gradient_button_style("#10b981", "#34d399", "#34d399", "#6ee7b7")
        )
        ...
        move_other_btn.setStyleSheet(
            get_gradient_button_style("#6b7280", "#9ca3af", "#9ca3af", "#d1d5db")
        )
