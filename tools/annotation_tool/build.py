...
def build_app(platform=None):
    ...
    cmd = [
        ...
        "--windowed",
        "--onefile",
        "--icon", str(current_dir / "icon.ico"),
        "--add-data", f"{current_dir}/roles.json:.",
        "--add-data", f"{current_dir}/annotations/:annotations/",
    ]
    ...
    if platform == 'mac':
        cmd.extend([
            ...
            "--osx-bundle-identifier", "com.example.animeroleannotator",
        ])
