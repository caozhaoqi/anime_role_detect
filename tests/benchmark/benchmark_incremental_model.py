...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=str, default="models/benchmark", help="输出目录")
...
def print_results(results):
    ...
    for class_name, metrics in results["per_class_metrics"].items():
        print(
            f"{class_name:<10} {metrics['precision']:<10.4f} {metrics['recall']:<10.4f} {metrics['f1_score']:<10.4f} {metrics['support']:<10}"
        )
...
def main():
    ...
    for model_type, results in all_results.items():
        print(
            f"{model_type:<15} {results['accuracy']*100:<10.2f} {results['precision']*100:<10.2f} {results['recall']*100:<10.2f} {results['f1_score']*100:<10.2f} {results['fps']:<10.2f}"
        )
