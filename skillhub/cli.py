...
使用示例:
  ...
  ardc tags                         # 列出标签
    ...
    skill_subparsers.add_parser("list", help="列出所有技能").add_argument(
        "-c", "--category", help="按分类筛选"
    )
    skill_subparsers.add_parser("search", help="搜索技能").add_argument(
        "keyword", help="搜索关键词"
    )
    ...
    skill_subparsers.add_parser("uninstall", help="卸载技能").add_argument(
        "skill_id", help="技能ID"
    )
    skill_subparsers.add_parser("versions", help="查看技能版本").add_argument(
        "skill_id", help="技能ID"
    )
