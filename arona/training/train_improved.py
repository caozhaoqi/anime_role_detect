...
def get_model(model_type, num_classes, dropout_rate=0.5):
...
def train_model(model, train_loader, val_loader, device, num_epochs=50, lr=0.0001, weight_decay=0.001, output_dir='models/improved', class_to_idx=None):
    ...
    results = {
        'model_type': 'mobilenet_v2_improved',
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='../../models/improved', help='输出目录')
