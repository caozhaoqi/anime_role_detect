...
def train_model(model, train_loader, val_loader, device, num_epochs=80, lr=0.0005, weight_decay=0.0002, 
                output_dir='models/efficientnet', class_to_idx=None, use_mixup=True, label_smoothing=0.1):
...
def main():
    parser = argparse.ArgumentParser(description='EfficientNet训练脚本')
    ...
    parser.add_argument('--output-dir', type=str, default='../../models/efficientnet_b3', help='输出目录')
