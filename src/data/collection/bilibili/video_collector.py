...
class BilibiliVideoCollector:
    ...
    def download_with_youtube_dl(self, url):
        ...
        try:
            ...
            cmd = ["youtube-dl", "-o", output_path, "--format", "best", url]
    ...
    def download_with_you_get(self, url):
        ...
        try:
            ...
            # 下载视频
            cmd = ["you-get", "-o", self.output_dir, url]
    ...
    def test_video(self, video_path):
        ...
        try:
            ...
            cmd = [
                "python3",
                "scripts/video_character_detection.py",
                "--input_video",
                video_path,
                "--output_video",
                os.path.join(self.output_dir, f"detected_{os.path.basename(video_path)}"),
            ]
...
def main():
    ...
    parser.add_argument("--urls", type=str, nargs="+", help="B站视频URL列表")
    parser.add_argument("--use_recommended", action="store_true", help="使用推荐的视频URL")
    parser.add_argument("--output_dir", type=str, default="data/videos", help="输出目录")
    parser.add_argument("--test", action="store_true", help="测试下载的视频")
