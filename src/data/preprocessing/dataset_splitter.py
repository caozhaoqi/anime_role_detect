...
class DatasetSplitter:
    ...
    def split_dataset(self):
        ...
        for character_dir in os.listdir(self.input_dir):
            ...
            logger.info(
                f"{character_dir}: 训练集 {len(train_images)} 张, 验证集 {len(val_images)} 张"
            )
...
def main():
    ...
    parser.add_argument("--input-dir", type=str, default="data/train", help="输入目录")
    parser.add_argument("--output-dir", type=str, default="data/split_dataset", help="输出目录")
