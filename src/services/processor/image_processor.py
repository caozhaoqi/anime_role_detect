...
async def process_single_image(
    ...
    try:
        ...
        # 处理图像
        logger.info(
            f"process_single_image 参数: use_model={use_model}, use_coreml={use_coreml}, model_name={model_name}, use_deepdanbooru={use_deepdanbooru}"
        )
...
async def process_multi_role_image(
    ...
    try:
        ...
        # 处理图像
        logger.info(
            f"process_multi_role_image 参数: use_model={use_model}, use_coreml={use_coreml}, model_name={model_name}, use_deepdanbooru={use_deepdanbooru}"
        )
