...
# 创建FastAPI应用
app = FastAPI(
    title="Video Recognition Service", description="视频实时抽帧识别服务", version="1.0.0"
)
...
async def extract_frames(file: UploadFile = File(...), frame_interval: float = 1.0):
    """
    从视频中提取帧
...
async def get_stats():
    """获取服务统计信息"""
    return {"status": "running", "service": "video_recognition_service"}
