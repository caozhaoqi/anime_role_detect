...
class MultiRoleDetector:
    ...
    def detect_roles(self, image_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(
                f"模型加载状态: model={self.model is not None}, class_to_idx={self.class_to_idx is not None}"
            )
    ...
    def _detect_roles_with_face_detection(
        ...
        try:
            ...
            faces = face_cascade.detectMultiScale(
                gray, scaleFactor=1.05, minNeighbors=3, minSize=(20, 20), maxSize=(200, 200)
            )
