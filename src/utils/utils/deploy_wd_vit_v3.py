...
def download_model(model_id, model_dir):
    ...
    for file_name in files_to_download:
        try:
            file_path = hf_hub_download(repo_id=model_id, filename=file_name, local_dir=model_dir)
...
def main():
    ...
    parser.add_argument(
        "--model-id", type=str, default="SmilingWolf/wd-vit-v3", help="Hugging Face模型ID"
    )
