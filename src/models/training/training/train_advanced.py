...
def train_model(
    ...
    logger.info(f": Mixup={use_mixup}, CutMix={use_cutmix}, ={label_smoothing}")
...
def main():
    ...
    parser.add_argument("--use-cutmix", action="store_true", help="CutMix")
    parser.add_argument("--output-dir", type=str, default="../../models/advanced", help="")
