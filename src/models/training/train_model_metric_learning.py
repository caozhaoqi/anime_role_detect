...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="models/metric_learning", help="输出目录")
    ...
    parser.add_argument("--feature-dim", type=int, default=512, help="特征维度")
    ...
    model = MetricLearningModel(
        num_classes=num_classes, feature_dim=args.feature_dim, loss_type=args.loss_type
    )
    model.to(device)
