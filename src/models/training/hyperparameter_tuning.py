...
class HyperparameterTuner:
    ...
    def train_with_hyperparameters(self, hyperparams, num_epochs=20):
        ...
        scheduler = CosineAnnealingLR(
            optimizer, T_max=num_epochs, eta_min=hyperparams["learning_rate"] * 1e-4
        )
        ...
        result = {"hyperparams": hyperparams, "best_val_acc": best_val_acc, "history": history}
...
def main():
    ...
    parser.add_argument(
        "--train-dir", type=str, default="data/split_dataset/train", help="训练集目录"
    )
    parser.add_argument("--val-dir", type=str, default="data/split_dataset/val", help="验证集目录")
    parser.add_argument("--output-dir", type=str, default="tuning_results", help="输出目录")
    parser.add_argument(
        "--method", type=str, choices=["grid", "random"], default="random", help="搜索方法"
    )
    parser.add_argument("--num-epochs", type=int, default=20, help="每组参数的训练轮数")
    parser.add_argument("--n-trials", type=int, default=10, help="随机搜索的试验次数")
