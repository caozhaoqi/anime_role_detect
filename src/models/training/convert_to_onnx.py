...
class ModelConverter:
    ...
    def create_model(self):
        ...
        # 检测模型结构类型
        classifier_keys = [
            k for k in self.checkpoint["model_state_dict"].keys() if "classifier" in k
        ]
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="models/onnx", help="ONNX模型输出目录")
    parser.add_argument("--output-name", type=str, default=None, help="ONNX模型输出文件名")
    parser.add_argument(
        "--input-size",
        type=int,
        nargs=4,
